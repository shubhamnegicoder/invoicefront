        ...
        return(
          ...
          <Grid container>
            <ItemGrid xs={12} sm={12} md={12}>
              <RegularCard
                 cardTitle={<div>Product<Tooltip id="tooltip-icon" title="Add Product"><Button style={{float: "right" , backgroundColor:"#76323f",  color:"white"}} aria-label="add" variant="fab"onClick={this.handleOpen} >
              <AddIcon /> </Button></Tooltip><Tooltip id="tooltip-icon" title="Search"><Button style={{float: "right" , backgroundColor:"#76323f",  color:"white"}} aria-label="add" variant="fab"onClick={this.handleOpen1} ><Search/>
              </Button></Tooltip></div>
              }
